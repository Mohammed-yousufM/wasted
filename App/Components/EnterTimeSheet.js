...
export default function EnterTimeSheet({navigation}) {
  ...
  return (
    <Container>
      ...
      {/* <NavigationEvents
        onWillFocus={() => {
          refreshScreen ? loginData() : null;
          setRefreshScreen(false);
        }}
        onWillBlur={() => setRefreshScreen(true)}
      /> */}
      <Content>
        {loading ? (
          <ActivityIndicator
              ...
              <LinearGradient
                ...
                <View
                  ...
                  <Text style={styles.headerText}>
                    {fobject.startDate} -{fobject.endDate}
                  </Text>
                  <View style={{backgroundColor: 'transparent', width: 20}}>
                    <Icon
              ...
              <Grid style={{paddingRight: 7, paddingLeft: 7}}>
                <Row style={{paddingBottom: 7, paddingTop: 7}}>
                  ...
                  <Col
                    ...
                    <Text
                      style={[styles.cardHeaderText1, {fontWeight: 'bold'}]}>
                      {'Regular Hours'}
                    </Text>
                  </Col>
                  <Col
                    ...
                    <Row style={{paddingBottom: 7}} key={index}>
                      <Col style={styles.cardHeader}>
                        <View
                          ...
                          <Text style={styles.cardHeaderText}>{weekDay}</Text>
                        </View>
                      </Col>
                      <Col
                        style={styles.cardHeader}
